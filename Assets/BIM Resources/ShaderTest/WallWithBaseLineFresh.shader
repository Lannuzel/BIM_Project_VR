Shader "Custom/Wall_URP_Stencil_XR_Fresh"
{
    Properties
    {
    ...
    SubShader
    {
        // Opaque, broad URP compatibility
        ...
        Pass
        {
            ...
            // Key rule: wall draws only where stencil != Ref
        ...
        // ---------- DEPTH-ONLY PASS ----------
        // Prevents wall depth in the hole during URP depth prepass/priming
        Pass
        {
            Name "DepthOnly"
        ...
        // ---------- DEPTH-NORMALS-ONLY PASS ----------
        // Covers SSAO/DepthNormals pipelines so the hole stays open
        Pass
        {
