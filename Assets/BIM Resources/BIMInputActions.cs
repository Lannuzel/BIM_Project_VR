...
//     version 1.8.1
//     from Assets/BIM Resources/BIM Input Actions.inputactions
//
...
public partial class @BIMInputActions: IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @BIMInputActions()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""BIM Input Actions"",
    ""maps"": [
        {
            ""name"": ""XRI Head"",
    ...
    ~@BIMInputActions()
    {
        Debug.Assert(!m_XRIHead.enabled, "This will cause a leak and performance issues, BIMInputActions.XRIHead.Disable() has not been called.");
        Debug.Assert(!m_XRILeft.enabled, "This will cause a leak and performance issues, BIMInputActions.XRILeft.Disable() has not been called.");
        Debug.Assert(!m_XRILeftInteraction.enabled, "This will cause a leak and performance issues, BIMInputActions.XRILeftInteraction.Disable() has not been called.");
        Debug.Assert(!m_XRILeftLocomotion.enabled, "This will cause a leak and performance issues, BIMInputActions.XRILeftLocomotion.Disable() has not been called.");
        Debug.Assert(!m_XRIRight.enabled, "This will cause a leak and performance issues, BIMInputActions.XRIRight.Disable() has not been called.");
        Debug.Assert(!m_XRIRightInteraction.enabled, "This will cause a leak and performance issues, BIMInputActions.XRIRightInteraction.Disable() has not been called.");
        Debug.Assert(!m_XRIRightLocomotion.enabled, "This will cause a leak and performance issues, BIMInputActions.XRIRightLocomotion.Disable() has not been called.");
        Debug.Assert(!m_XRIUI.enabled, "This will cause a leak and performance issues, BIMInputActions.XRIUI.Disable() has not been called.");
        Debug.Assert(!m_TouchscreenGestures.enabled, "This will cause a leak and performance issues, BIMInputActions.TouchscreenGestures.Disable() has not been called.");
    }
    ...
    {
        private @BIMInputActions m_Wrapper;
        public XRIHeadActions(@BIMInputActions wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @BIMInputActions m_Wrapper;
        public XRILeftActions(@BIMInputActions wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @BIMInputActions m_Wrapper;
        public XRILeftInteractionActions(@BIMInputActions wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @BIMInputActions m_Wrapper;
        public XRILeftLocomotionActions(@BIMInputActions wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @BIMInputActions m_Wrapper;
        public XRIRightActions(@BIMInputActions wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @BIMInputActions m_Wrapper;
        public XRIRightInteractionActions(@BIMInputActions wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @BIMInputActions m_Wrapper;
        public XRIRightLocomotionActions(@BIMInputActions wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @BIMInputActions m_Wrapper;
        public XRIUIActions(@BIMInputActions wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @BIMInputActions m_Wrapper;
        public TouchscreenGesturesActions(@BIMInputActions wrapper) { m_Wrapper = wrapper; }
