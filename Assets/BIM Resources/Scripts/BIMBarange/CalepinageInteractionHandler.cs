...
public class CalepinageInteractionHandler : NetworkBehaviour
{
    public XRIBIMInputActions playerInputActions;
    public Transform cameraTransform; // Player's camera transform
    private static CalepinageInteractionHandler _instance;
    ...
    public static CalepinageInteractionHandler Instance
    {
        get
        {
            if (_instance == null)
            {
                _instance = FindObjectOfType<CalepinageInteractionHandler>();
                if (_instance == null)
                {
                    GameObject obj = new GameObject("CalepinageInteractionHandler");
                    _instance = obj.AddComponent<CalepinageInteractionHandler>();
                }
            }
            return _instance;
        }
