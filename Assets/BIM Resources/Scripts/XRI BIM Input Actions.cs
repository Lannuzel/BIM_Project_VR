...
public partial class @XRIBIMInputActions: IInputActionCollection2, IDisposable
{
    ...
    ~@XRIBIMInputActions()
    {
        Debug.Assert(!m_XRIHead.enabled, "This will cause a leak and performance issues, XRIBIMInputActions.XRIHead.Disable() has not been called.");
        Debug.Assert(!m_XRILeft.enabled, "This will cause a leak and performance issues, XRIBIMInputActions.XRILeft.Disable() has not been called.");
        Debug.Assert(!m_XRILeftInteraction.enabled, "This will cause a leak and performance issues, XRIBIMInputActions.XRILeftInteraction.Disable() has not been called.");
        Debug.Assert(!m_XRILeftLocomotion.enabled, "This will cause a leak and performance issues, XRIBIMInputActions.XRILeftLocomotion.Disable() has not been called.");
        Debug.Assert(!m_XRIRight.enabled, "This will cause a leak and performance issues, XRIBIMInputActions.XRIRight.Disable() has not been called.");
        Debug.Assert(!m_XRIRightInteraction.enabled, "This will cause a leak and performance issues, XRIBIMInputActions.XRIRightInteraction.Disable() has not been called.");
        Debug.Assert(!m_XRIRightLocomotion.enabled, "This will cause a leak and performance issues, XRIBIMInputActions.XRIRightLocomotion.Disable() has not been called.");
        Debug.Assert(!m_XRIUI.enabled, "This will cause a leak and performance issues, XRIBIMInputActions.XRIUI.Disable() has not been called.");
        Debug.Assert(!m_TouchscreenGestures.enabled, "This will cause a leak and performance issues, XRIBIMInputActions.TouchscreenGestures.Disable() has not been called.");
    }
